...
class HandlerStack
{
    ...
    {
        $stack = new self($handler ?: \PostSMTP\Vendor\GuzzleHttp\Utils::chooseHandler());
        $stack->push(\PostSMTP\Vendor\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\PostSMTP\Vendor\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\PostSMTP\Vendor\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\PostSMTP\Vendor\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
