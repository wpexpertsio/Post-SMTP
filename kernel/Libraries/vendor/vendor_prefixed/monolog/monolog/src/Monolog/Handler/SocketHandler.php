 ...
 */
class SocketHandler extends \PostSMTP\Vendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($connectionString, $level = \PostSMTP\Vendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
