 ...
 */
abstract class AbstractHandler implements \PostSMTP\Vendor\Monolog\Handler\HandlerInterface, \PostSMTP\Vendor\Monolog\ResettableInterface
{
    protected $level = \PostSMTP\Vendor\Monolog\Logger::DEBUG;
