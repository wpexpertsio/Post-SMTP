 ...
 */
namespace PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath\Reductions;

use PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath;
use PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath\Base;
/**
 * PHP Barrett Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class EvalBarrett extends \PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath\Base
{
    /**
     ...
     */
    protected static function generateCustomReduction(\PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $m, $class)
    {
        $m_length = \strlen($m);
        if ($m_length < 5) {
