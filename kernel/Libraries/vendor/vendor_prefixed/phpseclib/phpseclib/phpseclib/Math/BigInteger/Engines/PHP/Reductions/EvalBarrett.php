 ...
 */
namespace PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Reductions;

use PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP;
use PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Base;
/**
 * PHP Dynamic Barrett Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class EvalBarrett extends \PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Base
{
    /**
     ...
     * @return callable
     */
    protected static function generateCustomReduction(\PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP $m, $class)
    {
