 ...
 * @author  Jim Wigginton <terrafrost@php.net>
 */
class PublicKey extends \PostSMTP\Vendor\phpseclib3\Crypt\DSA implements \PostSMTP\Vendor\phpseclib3\Crypt\Common\PublicKey
{
    ...
    public function verify($message, $signature)
    {
        ...
        if (self::$engines['OpenSSL'] && \in_array($this->hash->getHash(), \openssl_get_md_methods())) {
            $sig = $format != 'ASN1' ? \PostSMTP\Vendor\phpseclib3\Crypt\DSA\Formats\Signature\ASN1::save($r, $s) : $signature;
