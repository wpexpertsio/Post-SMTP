 ...
 */
use PostSMTP\Vendor\Symfony\Polyfill\Intl\Idn as p;
...
if (!\function_exists('idn_to_ascii')) {
    ...
    {
        return \PostSMTP\Vendor\Symfony\Polyfill\Intl\Idn\Idn::idn_to_ascii((string) $domain, (int) $flags, (int) $variant, $idna_info);
    }
}
if (!\function_exists('idn_to_utf8')) {
    ...
    {
        return \PostSMTP\Vendor\Symfony\Polyfill\Intl\Idn\Idn::idn_to_utf8((string) $domain, (int) $flags, (int) $variant, $idna_info);
    }
}
