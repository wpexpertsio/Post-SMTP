...
class UsersSettingsCseKeypairs extends \PostSMTP\Vendor\Google\Service\Resource
{
     ...
     * @return CseKeyPair
     */
    public function create($userId, \PostSMTP\Vendor\Google\Service\Gmail\CseKeyPair $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('create', [$params], \PostSMTP\Vendor\Google\Service\Gmail\CseKeyPair::class);
    }
    /**
     ...
     * @return CseKeyPair
     */
    public function disable($userId, $keyPairId, \PostSMTP\Vendor\Google\Service\Gmail\DisableCseKeyPairRequest $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'keyPairId' => $keyPairId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('disable', [$params], \PostSMTP\Vendor\Google\Service\Gmail\CseKeyPair::class);
    }
    /**
     ...
     * @return CseKeyPair
     */
    public function enable($userId, $keyPairId, \PostSMTP\Vendor\Google\Service\Gmail\EnableCseKeyPairRequest $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'keyPairId' => $keyPairId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('enable', [$params], \PostSMTP\Vendor\Google\Service\Gmail\CseKeyPair::class);
    }
    /**
    ...
    public function get($userId, $keyPairId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \PostSMTP\Vendor\Google\Service\Gmail\CseKeyPair::class);
    }
    /**
    ...
    public function listUsersSettingsCseKeypairs($userId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \PostSMTP\Vendor\Google\Service\Gmail\ListCseKeyPairsResponse::class);
    }
    /**
     ...
     * @param array $optParams Optional parameters.
     */
    public function obliterate($userId, $keyPairId, \PostSMTP\Vendor\Google\Service\Gmail\ObliterateCseKeyPairRequest $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'keyPairId' => $keyPairId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
