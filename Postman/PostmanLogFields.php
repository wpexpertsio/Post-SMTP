...
class PostmanLogFields {
	...
	private $fields = array(
		...
		'solution'           => array( 'PostmanLogFields', 'sanitize_message' ),
		'from_header'        => array( 'PostmanLogFields', 'email_header_sanitize' ),
		'to_header'          => array( 'PostmanLogFields', 'email_header_sanitize' ),
		'cc_header'          => array( 'PostmanLogFields', 'email_header_sanitize' ),
		'bcc_header'         => array( 'PostmanLogFields', 'email_header_sanitize' ),
		'reply_to_header'    => array( 'PostmanLogFields', 'email_header_sanitize' ),
	...
	public function email_header_sanitize( $value ) {
		...
		return ! empty( $sanitized ) ? implode( ',', $sanitized ) : implode( ',', array_map( array( $this, 'sanitize_email' ), $parts ) );
	}
