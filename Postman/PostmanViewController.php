		...
		public function outputDefaultContent() {
			...
			<div class="ps-flex ps-home-main">
				...
				<div class="ps-setting-box">
					...
					<div>
						<a href="<?php echo esc_url( 'https://postmansmtp.com/extensions/office-365-for-post-smtp-extension/?utm_source=wp_dashboard' ); ?>" target="_blank">
							<img src="<?php echo esc_url( POST_SMTP_ASSETS . 'images/icons/finger.png' ) ?>" width="15" />
							<?php echo esc_html( 'Office 365' ); ?>
						</a>
					</div>
					<div>
						<a href="<?php echo esc_url( 'https://postmansmtp.com/extensions/post-smtp-extension-for-amazon-ses/?utm_source=wp_dashboard' ); ?>" target="_blank">
							<img src="<?php echo esc_url( POST_SMTP_ASSETS . 'images/icons/finger.png' ) ?>" width="15" />	
							<?php echo esc_html( 'Amazon SES' ); ?>
						</a>
					</div>
					<div>
						<a href="<?php echo esc_url( 'https://postmansmtp.com/extensions/email-log-attachment/?utm_source=wp_dashboard' ); ?>" target="_blank">
							<img src="<?php echo esc_url( POST_SMTP_ASSETS . 'images/icons/finger.png' ) ?>" width="15" />	
							<?php echo esc_html( 'Email Log attachment' ); ?>
						</a>
					</div>
					<div>
						<a href="<?php echo esc_url( 'https://postmansmtp.com/extensions/reporting-and-tracking-extension/?utm_source=wp_dashboard' ); ?>" target="_blank">
							<img src="<?php echo esc_url( POST_SMTP_ASSETS . 'images/icons/finger.png' ) ?>" width="15" />	
							<?php echo esc_html( 'Report & Tracking' ); ?>
						</a>
					</div>
					<div>
						<a href="<?php echo esc_url( 'https://postmansmtp.com/extensions/advanced-email-delivery/?utm_source=wp_dashboard' ); ?>" target="_blank">
							<img src="<?php echo esc_url( POST_SMTP_ASSETS . 'images/icons/finger.png' ) ?>" width="15" />	
							<?php echo esc_html( 'Advanced Email Delivery and Logs' ); ?>
						</a>
					</div>
					<div>
						<a href="<?php echo esc_url( 'https://postmansmtp.com/extensions/twilio-extension-pro/?utm_source=wp_dashboard' ); ?>" target="_blank">
							<img src="<?php echo esc_url( POST_SMTP_ASSETS . 'images/icons/finger.png' ) ?>" width="15" />	
							<?php echo esc_html( 'Twilio' ); ?>
						</a>
					</div>
					<div>
						<a href="<?php echo esc_url( 'https://postmansmtp.com/extensions/zoho-mail-pro-extension/?utm_source=wp_dashboard' ); ?>" target="_blank">
							<img src="<?php echo esc_url( POST_SMTP_ASSETS . 'images/icons/finger.png' ) ?>" width="15" />	
