 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Postman_Zend_Mail_Storage_Writable_Maildir extends Postman_Zend_Mail_Storage_Folder_Maildir implements Postman_Zend_Mail_Storage_Writable_Interface {
	...
	protected function _createTmpFile( $folder = 'INBOX' ) {
		...
		if ( ! $fh ) {
			 ...
			 */
			require_once 'Zend/Mail/Storage/Exception.php';
			throw new Postman_Zend_Mail_Storage_Exception(
				"tried $max_tries unique ids for a temp file, but all were taken"
												. ' - giving up'
			);
		}
