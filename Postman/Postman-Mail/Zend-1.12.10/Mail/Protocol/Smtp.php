	...
	public function helo( $host = '127.0.0.1' ) {
		...
		if ( $this->_secure == 'tls' ) {
			...
			if ( $this->_host == 'smtp.office365.com' && ! $tlsv1_2_installed ) {
				...
				$error = sprintf(
					'Office365 SMTP servie require TLS v1.2 and OpenSSL version 1.0.1 or greater, your current OpenSSL version is: %s.
You need to contact your web hosting support for help.',
					$ver_match[1]
				);
