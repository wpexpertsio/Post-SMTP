...
use PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine;
/**
...
class BigInteger implements \JsonSerializable {
	 ...
	 * @return void
	 */
	public static function setEngine( $main, array $modexps = array( 'DefaultEngine' ) ) {
		self::$engines = array();
		$fqmain        = 'PostSMTP\\Vendor\\phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
		...
		if ( ! $fqmain::isValidEngine() ) {
			throw new \PostSMTP\Vendor\phpseclib3\Exception\BadConfigurationException( "{$main} is not setup correctly on this system" );
		}
		...
		if ( ! $found ) {
			throw new \PostSMTP\Vendor\phpseclib3\Exception\BadConfigurationException( "No valid modular exponentiation engine found for {$main}" );
		}
		self::$engines = array( $main, $modexp );
	}
	/**
	...
	private static function initialize_static_variables() {
		if ( ! isset( self::$mainEngine ) ) {
			$engines = array( array( 'GMP' ), array( 'PHP64', array( 'OpenSSL' ) ), array( 'BCMath', array( 'OpenSSL' ) ), array( 'PHP32', array( 'OpenSSL' ) ) );
			foreach ( $engines as $engine ) {
				try {
					self::setEngine( $engine[0], isset( $engine[1] ) ? $engine[1] : array() );
					break;
				} catch ( \Exception $e ) {
				}
			}
	...
	public function __construct( $x = 0, $base = 10 ) {
		...
		if ( $x instanceof self::$mainEngine ) {
			$this->value = clone $x;
		} elseif ( $x instanceof \PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine ) {
	 ...
	 * @return BigInteger
	 */
	public function add( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $y ) {
	 ...
	 * @return BigInteger
	 */
	public function subtract( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $y ) {
	 ...
	 * @return BigInteger
	 */
	public function multiply( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $x ) {
	 ...
	 * @return BigInteger[]
	 */
	public function divide( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $y ) {
		list($q, $r) = $this->value->divide( $y->value );
		return array( new static( $q ), new static( $r ) );
	}
	/**
	 ...
	 * @return BigInteger
	 */
	public function modInverse( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $n ) {
	 ...
	 * @return BigInteger[]
	 */
	public function extendedGCD( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $n ) {
	 ...
	 * @return BigInteger
	 */
	public function gcd( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $n ) {
	 ...
	 * @return BigInteger
	 */
	public function powMod( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $e, \PostSMTP\Vendor\phpseclib3\Math\BigInteger $n ) {
	 ...
	 * @return BigInteger
	 */
	public function modPow( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $e, \PostSMTP\Vendor\phpseclib3\Math\BigInteger $n ) {
	 ...
	 * @see self::equals()
	 */
	public function compare( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $y ) {
	 ...
	 * @return bool
	 */
	public function equals( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $x ) {
	 ...
	 * @return BigInteger
	 */
	public function bitwise_and( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $x ) {
	 ...
	 * @return BigInteger
	 */
	public function bitwise_or( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $x ) {
	 ...
	 * @return BigInteger
	 */
	public function bitwise_xor( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $x ) {
	 ...
	 */
	public static function randomRangePrime( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $min, \PostSMTP\Vendor\phpseclib3\Math\BigInteger $max ) {
		$class = self::$mainEngine;
	 ...
	 * @return BigInteger
	 */
	public static function randomRange( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $min, \PostSMTP\Vendor\phpseclib3\Math\BigInteger $max ) {
		$class = self::$mainEngine;
	 ...
	 * @return BigInteger
	 */
	public function pow( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $n ) {
	 ...
	 * @return BigInteger
	 */
	public static function min( \PostSMTP\Vendor\phpseclib3\Math\BigInteger ...$nums ) {
		$class = self::$mainEngine;
		$nums  = \array_map(
			function ( $num ) {
				return $num->value;
	 ...
	 * @return BigInteger
	 */
	public static function max( \PostSMTP\Vendor\phpseclib3\Math\BigInteger ...$nums ) {
		$class = self::$mainEngine;
		$nums  = \array_map(
			function ( $num ) {
				return $num->value;
	 ...
	 * @return bool
	 */
	public function between( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $min, \PostSMTP\Vendor\phpseclib3\Math\BigInteger $max ) {
	 ...
	 * @return int
	 */
	public static function scan1divide( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $r ) {
		$class = self::$mainEngine;
	...
	public function createRecurringModuloFunction() {
		...
		return function ( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $x ) use ( $func ) {
