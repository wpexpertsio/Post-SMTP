...
use PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Montgomery as Progenitor;
/**
 * PHP Montgomery Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class Montgomery extends \PostSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Montgomery {
	...
	protected static function reduce( array $x, array $n, $class ) {
		...
		for ( $i = 0; $i < $k; ++$i ) {
			...
			$temp   = $class::regularMultiply( array( $temp ), $n );
