...
abstract class PKCS1 extends \PostSMTP\Vendor\phpseclib3\Crypt\Common\Formats\Keys\PKCS1 {
	 ...
	 * @return string
	 */
	public static function saveParameters( \PostSMTP\Vendor\phpseclib3\Math\BigInteger $prime, \PostSMTP\Vendor\phpseclib3\Math\BigInteger $base, array $options = array() ) {
		$params = array(
			'prime' => $prime,
			'base'  => $base,
		);
