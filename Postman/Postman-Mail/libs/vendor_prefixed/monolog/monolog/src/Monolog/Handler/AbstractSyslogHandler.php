...
abstract class AbstractSyslogHandler extends \PostSMTP\Vendor\Monolog\Handler\AbstractProcessingHandler {
	...
	protected $logLevels = array(
		\PostSMTP\Vendor\Monolog\Logger::DEBUG     => \LOG_DEBUG,
		\PostSMTP\Vendor\Monolog\Logger::INFO      => \LOG_INFO,
		\PostSMTP\Vendor\Monolog\Logger::NOTICE    => \LOG_NOTICE,
		\PostSMTP\Vendor\Monolog\Logger::WARNING   => \LOG_WARNING,
		\PostSMTP\Vendor\Monolog\Logger::ERROR     => \LOG_ERR,
		\PostSMTP\Vendor\Monolog\Logger::CRITICAL  => \LOG_CRIT,
		\PostSMTP\Vendor\Monolog\Logger::ALERT     => \LOG_ALERT,
		\PostSMTP\Vendor\Monolog\Logger::EMERGENCY => \LOG_EMERG,
	);
	/**
