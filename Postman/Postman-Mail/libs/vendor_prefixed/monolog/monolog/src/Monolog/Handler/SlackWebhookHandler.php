 ...
 */
class SlackWebhookHandler extends \PostSMTP\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     * Slack Webhook token
     * @var string
     ...
     */
    public function __construct($webhookUrl, $channel = null, $username = null, $useAttachment = \true, $iconEmoji = null, $useShortAttachment = \false, $includeContextAndExtra = \false, $level = \PostSMTP\Vendor\Monolog\Logger::CRITICAL, $bubble = \true, array $excludeFields = array())
    {
