 ...
 */
class IntrospectionProcessor implements \PostSMTP\Vendor\Monolog\Processor\ProcessorInterface
{
    private $level;
    private $skipClassesPartials;
    private $skipStackFramesCount;
    private $skipFunctions = array('call_user_func', 'call_user_func_array');
    public function __construct($level = \PostSMTP\Vendor\Monolog\Logger::DEBUG, array $skipClassesPartials = array(), $skipStackFramesCount = 0)
    {
        $this->level = \PostSMTP\Vendor\Monolog\Logger::toMonologLevel($level);
        $this->skipClassesPartials = \array_merge(array('PostSMTP\\Vendor\\Monolog\\'), $skipClassesPartials);
