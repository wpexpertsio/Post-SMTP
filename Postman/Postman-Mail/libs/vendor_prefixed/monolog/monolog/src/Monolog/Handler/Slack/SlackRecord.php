 ...
 */
namespace PostSMTP\Vendor\Monolog\Handler\Slack;
...
class SlackRecord
{
    ...
    public function __construct($channel = null, $username = null, $useAttachment = \true, $userIcon = null, $useShortAttachment = \false, $includeContextAndExtra = \false, array $excludeFields = array(), \PostSMTP\Vendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \PostSMTP\Vendor\Monolog\Formatter\NormalizerFormatter();
        }
    }
    ...
    public function stringify($fields)
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \PostSMTP\Vendor\Monolog\Utils::jsonEncode($normalized, $prettyPrintFlag | $flags) : \PostSMTP\Vendor\Monolog\Utils::jsonEncode($normalized, $flags);
    }
    /**
     * Sets the formatter
     *
