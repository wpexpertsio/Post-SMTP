...
class ZendMonitorHandler extends \PostSMTP\Vendor\Monolog\Handler\AbstractProcessingHandler {
	...
	public function __construct( $level = \PostSMTP\Vendor\Monolog\Logger::DEBUG, $bubble = \true ) {
		...
		$this->levelMap = array(
			\PostSMTP\Vendor\Monolog\Logger::DEBUG     => \PostSMTP\Vendor\ZEND_MONITOR_EVENT_SEVERITY_INFO,
			\PostSMTP\Vendor\Monolog\Logger::INFO      => \PostSMTP\Vendor\ZEND_MONITOR_EVENT_SEVERITY_INFO,
			\PostSMTP\Vendor\Monolog\Logger::NOTICE    => \PostSMTP\Vendor\ZEND_MONITOR_EVENT_SEVERITY_INFO,
			\PostSMTP\Vendor\Monolog\Logger::WARNING   => \PostSMTP\Vendor\ZEND_MONITOR_EVENT_SEVERITY_WARNING,
			\PostSMTP\Vendor\Monolog\Logger::ERROR     => \PostSMTP\Vendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR,
			\PostSMTP\Vendor\Monolog\Logger::CRITICAL  => \PostSMTP\Vendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR,
			\PostSMTP\Vendor\Monolog\Logger::ALERT     => \PostSMTP\Vendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR,
			\PostSMTP\Vendor\Monolog\Logger::EMERGENCY => \PostSMTP\Vendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR,
		);
