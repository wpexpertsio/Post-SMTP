 ...
 */
class RotatingFileHandler extends \PostSMTP\Vendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \PostSMTP\Vendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \PostSMTP\Vendor\Monolog\Utils::canonicalizePath($filename);
