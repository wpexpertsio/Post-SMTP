 ...
 */
class MandrillHandler extends \PostSMTP\Vendor\Monolog\Handler\MailHandler
{
    protected $message;
    protected $apiKey;
    /**
     ...
     */
    public function __construct($apiKey, $message, $level = \PostSMTP\Vendor\Monolog\Logger::ERROR, $bubble = \true)
    {
        parent::__construct($level, $bubble);
        if (!$message instanceof \PostSMTP\Vendor\Swift_Message && \is_callable($message)) {
