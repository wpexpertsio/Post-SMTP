 ...
 */
class BrowserConsoleHandler extends \PostSMTP\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \PostSMTP\Vendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
