 ...
 */
namespace PostSMTP\Vendor\Symfony\Polyfill\Mbstring;
...
final class Mbstring {
	...
	private const SIMPLE_CASE_FOLD   = array( array( 'µ', 'ſ', 'ͅ', 'ς', 'ϐ', 'ϑ', 'ϕ', 'ϖ', 'ϰ', 'ϱ', 'ϵ', 'ẛ', 'ι' ), array( 'μ', 's', 'ι', 'σ', 'β', 'θ', 'φ', 'π', 'κ', 'ρ', 'ε', 'ṡ', 'ι' ) );
	...
	public static function mb_stripos( $haystack, $needle, $offset = 0, $encoding = null ) {
		[$haystack, $needle] = \str_replace( self::SIMPLE_CASE_FOLD[0], self::SIMPLE_CASE_FOLD[1], array( self::mb_convert_case( $haystack, \MB_CASE_LOWER, $encoding ), self::mb_convert_case( $needle, \MB_CASE_LOWER, $encoding ) ) );
	...
	public static function mb_str_pad( string $string, int $length, string $pad_string = ' ', int $pad_type = \STR_PAD_RIGHT, string $encoding = null ): string {
		if ( ! \in_array( $pad_type, array( \STR_PAD_RIGHT, \STR_PAD_LEFT, \STR_PAD_BOTH ), \true ) ) {
