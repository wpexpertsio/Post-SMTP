...
final class TransferStats
{
     ...
     */
    public function __construct(\PostSMTP\Vendor\Psr\Http\Message\RequestInterface $request, \PostSMTP\Vendor\Psr\Http\Message\ResponseInterface $response = null, $transferTime = null, $handlerErrorData = null, $handlerStats = [])
    {
