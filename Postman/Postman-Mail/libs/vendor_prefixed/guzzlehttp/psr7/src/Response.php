 ...
 */
class Response implements \PostSMTP\Vendor\Psr\Http\Message\ResponseInterface
{
    use MessageTrait;
    ...
    public function withStatus($code, $reasonPhrase = '') : \PostSMTP\Vendor\Psr\Http\Message\ResponseInterface
    {
