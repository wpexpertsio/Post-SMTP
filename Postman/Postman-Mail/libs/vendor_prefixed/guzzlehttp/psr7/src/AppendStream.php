 ...
 */
final class AppendStream implements \PostSMTP\Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\PostSMTP\Vendor\Psr\Http\Message\StreamInterface $stream) : void
    {
