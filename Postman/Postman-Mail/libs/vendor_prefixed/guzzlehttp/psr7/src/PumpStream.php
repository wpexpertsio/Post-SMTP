 ...
 */
final class PumpStream implements \PostSMTP\Vendor\Psr\Http\Message\StreamInterface {
	...
	public function __construct( callable $source, array $options = array() ) {
		...
		$this->metadata = $options['metadata'] ?? array();
		$this->buffer   = new \PostSMTP\Vendor\GuzzleHttp\Psr7\BufferStream();
	}
