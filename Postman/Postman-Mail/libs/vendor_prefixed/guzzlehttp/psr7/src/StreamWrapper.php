...
class StreamWrapper
{
     ...
     */
    public static function getResource(\PostSMTP\Vendor\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\PostSMTP\Vendor\Psr\Http\Message\StreamInterface $stream)
    {
