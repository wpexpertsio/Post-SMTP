 ...
 */
class Stream implements \PostSMTP\Vendor\Psr\Http\Message\StreamInterface {
	...
	public function __construct( $stream, array $options = array() ) {
		...
		$this->customMetadata = $options['metadata'] ?? array();
		$this->stream         = $stream;
	...
	public function getContents(): string {
		...
		return \PostSMTP\Vendor\GuzzleHttp\Psr7\Utils::tryGetContents( $this->stream );
	}
