...
use PostSMTP\Vendor\Google\Auth\ServiceAccountSignerTrait;
 ...
 */
class ServiceAccountCredentials extends \PostSMTP\Vendor\Google\Auth\CredentialsLoader implements \PostSMTP\Vendor\Google\Auth\GetQuotaProjectInterface, \PostSMTP\Vendor\Google\Auth\SignBlobInterface, \PostSMTP\Vendor\Google\Auth\ProjectIdProviderInterface
{
    ...
    public function __construct($scope, $jsonKey, $sub = null, $targetAudience = null)
    {
        ...
        $this->auth = new \PostSMTP\Vendor\Google\Auth\OAuth2(['audience' => self::TOKEN_CREDENTIAL_URI, 'issuer' => $jsonKey['client_email'], 'scope' => $scope, 'signingAlgorithm' => 'RS256', 'signingKey' => $jsonKey['private_key'], 'sub' => $sub, 'tokenCredentialUri' => self::TOKEN_CREDENTIAL_URI, 'additionalClaims' => $additionalClaims]);
    ...
    private function createJwtAccessCredentials()
    {
        if (!$this->jwtAccessCredentials) {
            ...
            $this->jwtAccessCredentials = new \PostSMTP\Vendor\Google\Auth\Credentials\ServiceAccountJwtAccessCredentials($credJson, $this->auth->getScope());
        }
