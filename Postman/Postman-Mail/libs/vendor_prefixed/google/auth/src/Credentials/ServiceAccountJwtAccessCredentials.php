 ...
 */
class ServiceAccountJwtAccessCredentials extends \PostSMTP\Vendor\Google\Auth\CredentialsLoader implements \PostSMTP\Vendor\Google\Auth\GetQuotaProjectInterface, \PostSMTP\Vendor\Google\Auth\SignBlobInterface, \PostSMTP\Vendor\Google\Auth\ProjectIdProviderInterface
{
    ...
    public function __construct($jsonKey, $scope = null)
    {
        ...
        $this->auth = new \PostSMTP\Vendor\Google\Auth\OAuth2(['issuer' => $jsonKey['client_email'], 'sub' => $jsonKey['client_email'], 'signingAlgorithm' => 'RS256', 'signingKey' => $jsonKey['private_key'], 'scope' => $scope]);
