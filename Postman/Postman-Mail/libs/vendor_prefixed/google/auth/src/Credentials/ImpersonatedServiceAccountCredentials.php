...
class ImpersonatedServiceAccountCredentials extends \PostSMTP\Vendor\Google\Auth\CredentialsLoader implements \PostSMTP\Vendor\Google\Auth\SignBlobInterface
{
    use IamSignerTrait;
    /**
     * @var string
    ...
    public function __construct($scope, $jsonKey)
    {
        ...
        $this->sourceCredentials = new \PostSMTP\Vendor\Google\Auth\Credentials\UserRefreshCredentials($scope, $jsonKey['source_credentials']);
    }
    /**
