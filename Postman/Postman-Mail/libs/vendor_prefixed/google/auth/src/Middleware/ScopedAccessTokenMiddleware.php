...
use PostSMTP\Vendor\Google\Auth\CacheTrait;
...
class ScopedAccessTokenMiddleware
{
     ...
     */
    public function __construct(callable $tokenFunc, $scopes, array $cacheConfig = null, \PostSMTP\Vendor\Psr\Cache\CacheItemPoolInterface $cache = null)
    {
