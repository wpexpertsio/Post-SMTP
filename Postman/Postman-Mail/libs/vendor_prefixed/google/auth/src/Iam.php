...
class Iam {
	 ...
	 */
	public function signBlob( $email, $accessToken, $stringToSign, array $delegates = array() ) {
		...
		$request = new \PostSMTP\Vendor\GuzzleHttp\Psr7\Request( 'POST', $uri, $headers, \PostSMTP\Vendor\GuzzleHttp\Psr7\Utils::streamFor( \json_encode( $body ) ) );
