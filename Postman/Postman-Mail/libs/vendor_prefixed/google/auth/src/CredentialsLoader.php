 ...
 */
abstract class CredentialsLoader implements \PostSMTP\Vendor\Google\Auth\FetchAuthTokenInterface, \PostSMTP\Vendor\Google\Auth\UpdateMetadataInterface {
	...
	public static function makeCredentials( $scope, array $jsonKey, $defaultScope = null ) {
		...
		if ( $jsonKey['type'] == 'service_account' ) {
			...
			return new \PostSMTP\Vendor\Google\Auth\Credentials\ServiceAccountCredentials( $scope, $jsonKey );
		}
	 ...
	 */
	public static function makeHttpClient( \PostSMTP\Vendor\Google\Auth\FetchAuthTokenInterface $fetcher, array $httpClientOptions = array(), callable $httpHandler = null, callable $tokenCallback = null ) {
		...
		return new \PostSMTP\Vendor\GuzzleHttp\Client(
			array(
				'handler' => $stack,
				'auth'    => 'google_auth',
			) + $httpClientOptions
	...
	public static function makeInsecureCredentials() {
		return new \PostSMTP\Vendor\Google\Auth\Credentials\InsecureCredentials();
	}
	/**
	...
	public function updateMetadata( $metadata, $authUri = null, callable $httpHandler = null ) {
		...
		if ( isset( $result['access_token'] ) ) {
			...
			$metadata_copy[ self::AUTH_METADATA_KEY ] = array( 'Bearer ' . $result['id_token'] );
		}
