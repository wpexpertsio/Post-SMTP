 ...
 */
class FetchAuthTokenCache implements \PostSMTP\Vendor\Google\Auth\FetchAuthTokenInterface, \PostSMTP\Vendor\Google\Auth\GetQuotaProjectInterface, \PostSMTP\Vendor\Google\Auth\SignBlobInterface, \PostSMTP\Vendor\Google\Auth\ProjectIdProviderInterface, \PostSMTP\Vendor\Google\Auth\UpdateMetadataInterface {
	...
	public function getClientName( callable $httpHandler = null ) {
		if ( ! $this->fetcher instanceof \PostSMTP\Vendor\Google\Auth\SignBlobInterface ) {
	...
	public function signBlob( $stringToSign, $forceOpenSsl = \false ) {
		...
		if ( $this->fetcher instanceof \PostSMTP\Vendor\Google\Auth\Credentials\GCECredentials ) {
	...
	public function getProjectId( callable $httpHandler = null ) {
		if ( ! $this->fetcher instanceof \PostSMTP\Vendor\Google\Auth\ProjectIdProviderInterface ) {
	...
	public function updateMetadata( $metadata, $authUri = null, callable $httpHandler = null ) {
		if ( ! $this->fetcher instanceof \PostSMTP\Vendor\Google\Auth\UpdateMetadataInterface ) {
		...
		if ( $cached ) {
			...
			if ( isset( $cached['access_token'] ) ) {
				$metadata[ self::AUTH_METADATA_KEY ] = array( 'Bearer ' . $cached['access_token'] );
			}
		}
