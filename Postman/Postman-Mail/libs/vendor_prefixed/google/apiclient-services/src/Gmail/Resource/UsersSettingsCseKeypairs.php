...
use PostSMTP\Vendor\Google\Service\Gmail\CseKeyPair;
use PostSMTP\Vendor\Google\Service\Gmail\DisableCseKeyPairRequest;
use PostSMTP\Vendor\Google\Service\Gmail\EnableCseKeyPairRequest;
use PostSMTP\Vendor\Google\Service\Gmail\ListCseKeyPairsResponse;
use PostSMTP\Vendor\Google\Service\Gmail\ObliterateCseKeyPairRequest;
/**
 ...
 *  </code>
 */
class UsersSettingsCseKeypairs extends \PostSMTP\Vendor\Google\Service\Resource {
	 ...
	 * @return CseKeyPair
	 */
	public function create( $userId, \PostSMTP\Vendor\Google\Service\Gmail\CseKeyPair $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'create', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\CseKeyPair::class );
	}
	/**
	 ...
	 * @return CseKeyPair
	 */
	public function disable( $userId, $keyPairId, \PostSMTP\Vendor\Google\Service\Gmail\DisableCseKeyPairRequest $postBody, $optParams = array() ) {
		$params = array(
			'userId'    => $userId,
			'keyPairId' => $keyPairId,
			'postBody'  => $postBody,
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'disable', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\CseKeyPair::class );
	}
	/**
	 ...
	 * @return CseKeyPair
	 */
	public function enable( $userId, $keyPairId, \PostSMTP\Vendor\Google\Service\Gmail\EnableCseKeyPairRequest $postBody, $optParams = array() ) {
		$params = array(
			'userId'    => $userId,
			'keyPairId' => $keyPairId,
			'postBody'  => $postBody,
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'enable', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\CseKeyPair::class );
	}
	/**
	 ...
	 * @return CseKeyPair
	 */
	public function get( $userId, $keyPairId, $optParams = array() ) {
		$params = array(
			'userId'    => $userId,
			'keyPairId' => $keyPairId,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\CseKeyPair::class );
	}
	/**
	 ...
	 */
	public function listUsersSettingsCseKeypairs( $userId, $optParams = array() ) {
		$params = array( 'userId' => $userId );
		$params = \array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\ListCseKeyPairsResponse::class );
	}
	/**
	 ...
	 * @param array                       $optParams Optional parameters.
	 */
	public function obliterate( $userId, $keyPairId, \PostSMTP\Vendor\Google\Service\Gmail\ObliterateCseKeyPairRequest $postBody, $optParams = array() ) {
		$params = array(
			'userId'    => $userId,
			'keyPairId' => $keyPairId,
			'postBody'  => $postBody,
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'obliterate', array( $params ) );
	}
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias( \PostSMTP\Vendor\Google\Service\Gmail\Resource\UsersSettingsCseKeypairs::class, 'PostSMTP\\Vendor\\Google_Service_Gmail_Resource_UsersSettingsCseKeypairs' );
