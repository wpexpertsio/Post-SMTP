...
class UsersMessages extends \PostSMTP\Vendor\Google\Service\Resource {
	 ...
	 */
	public function batchDelete( $userId, \PostSMTP\Vendor\Google\Service\Gmail\BatchDeleteMessagesRequest $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
	 ...
	 * @param array                      $optParams Optional parameters.
	 */
	public function batchModify( $userId, \PostSMTP\Vendor\Google\Service\Gmail\BatchModifyMessagesRequest $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
	...
	public function get( $userId, $id, $optParams = array() ) {
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Message::class );
	}
	/**
	 ...
	 * @return Message
	 */
	public function import( $userId, \PostSMTP\Vendor\Google\Service\Gmail\Message $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'import', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Message::class );
	}
	/**
	 ...
	 * @return Message
	 */
	public function insert( $userId, \PostSMTP\Vendor\Google\Service\Gmail\Message $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'insert', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Message::class );
	}
	/**
	...
	public function listUsersMessages( $userId, $optParams = array() ) {
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\ListMessagesResponse::class );
	}
	/**
	 ...
	 * @return Message
	 */
	public function modify( $userId, $id, \PostSMTP\Vendor\Google\Service\Gmail\ModifyMessageRequest $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'id'       => $id,
			'postBody' => $postBody,
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'modify', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Message::class );
	}
	/**
	 ...
	 * @return Message
	 */
	public function send( $userId, \PostSMTP\Vendor\Google\Service\Gmail\Message $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'send', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Message::class );
	}
	/**
	...
	public function trash( $userId, $id, $optParams = array() ) {
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'trash', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Message::class );
	}
	/**
	...
	public function untrash( $userId, $id, $optParams = array() ) {
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'untrash', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Message::class );
	}
}
