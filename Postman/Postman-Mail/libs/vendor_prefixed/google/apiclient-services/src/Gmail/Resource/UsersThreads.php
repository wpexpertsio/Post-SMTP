...
class UsersThreads extends \PostSMTP\Vendor\Google\Service\Resource {
	...
	public function get( $userId, $id, $optParams = array() ) {
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Thread::class );
	}
	/**
	...
	public function listUsersThreads( $userId, $optParams = array() ) {
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\ListThreadsResponse::class );
	}
	/**
	 ...
	 * @return Thread
	 */
	public function modify( $userId, $id, \PostSMTP\Vendor\Google\Service\Gmail\ModifyThreadRequest $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'id'       => $id,
			'postBody' => $postBody,
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'modify', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Thread::class );
	}
	/**
	...
	public function trash( $userId, $id, $optParams = array() ) {
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'trash', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Thread::class );
	}
	/**
	...
	public function untrash( $userId, $id, $optParams = array() ) {
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'untrash', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Thread::class );
	}
}
