...
use PostSMTP\Vendor\Google\Service\Gmail\CseIdentity;
use PostSMTP\Vendor\Google\Service\Gmail\ListCseIdentitiesResponse;
/**
 ...
 *  </code>
 */
class UsersSettingsCseIdentities extends \PostSMTP\Vendor\Google\Service\Resource {
	 ...
	 * @return CseIdentity
	 */
	public function create( $userId, \PostSMTP\Vendor\Google\Service\Gmail\CseIdentity $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'create', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\CseIdentity::class );
	}
	/**
	 ...
	 * @param array  $optParams Optional parameters.
	 */
	public function delete( $userId, $cseEmailAddress, $optParams = array() ) {
		$params = array(
			'userId'          => $userId,
	 ...
	 * @return CseIdentity
	 */
	public function get( $userId, $cseEmailAddress, $optParams = array() ) {
		$params = array(
			'userId'          => $userId,
			'cseEmailAddress' => $cseEmailAddress,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\CseIdentity::class );
	}
	/**
	 ...
	 */
	public function listUsersSettingsCseIdentities( $userId, $optParams = array() ) {
		$params = array( 'userId' => $userId );
		$params = \array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\ListCseIdentitiesResponse::class );
	}
	/**
	 ...
	 * @return CseIdentity
	 */
	public function patch( $userId, $emailAddress, \PostSMTP\Vendor\Google\Service\Gmail\CseIdentity $postBody, $optParams = array() ) {
		$params = array(
			'userId'       => $userId,
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'patch', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\CseIdentity::class );
	}
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias( \PostSMTP\Vendor\Google\Service\Gmail\Resource\UsersSettingsCseIdentities::class, 'PostSMTP\\Vendor\\Google_Service_Gmail_Resource_UsersSettingsCseIdentities' );
