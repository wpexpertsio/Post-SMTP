...
class UsersSettingsDelegates extends \PostSMTP\Vendor\Google\Service\Resource {
	 ...
	 * @return Delegate
	 */
	public function create( $userId, \PostSMTP\Vendor\Google\Service\Gmail\Delegate $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'create', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Delegate::class );
	}
	/**
	...
	public function get( $userId, $delegateEmail, $optParams = array() ) {
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\Delegate::class );
	}
	/**
	...
	public function listUsersSettingsDelegates( $userId, $optParams = array() ) {
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\ListDelegatesResponse::class );
	}
}
