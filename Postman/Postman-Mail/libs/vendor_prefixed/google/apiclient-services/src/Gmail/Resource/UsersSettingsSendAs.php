...
class UsersSettingsSendAs extends \PostSMTP\Vendor\Google\Service\Resource {
	 ...
	 * @return SendAs
	 */
	public function create( $userId, \PostSMTP\Vendor\Google\Service\Gmail\SendAs $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'create', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\SendAs::class );
	}
	/**
	...
	public function get( $userId, $sendAsEmail, $optParams = array() ) {
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\SendAs::class );
	}
	/**
	...
	public function listUsersSettingsSendAs( $userId, $optParams = array() ) {
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\ListSendAsResponse::class );
	}
	/**
	 ...
	 * @return SendAs
	 */
	public function patch( $userId, $sendAsEmail, \PostSMTP\Vendor\Google\Service\Gmail\SendAs $postBody, $optParams = array() ) {
		$params = array(
			'userId'      => $userId,
			'sendAsEmail' => $sendAsEmail,
			'postBody'    => $postBody,
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'patch', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\SendAs::class );
	}
	/**
	 ...
	 * @return SendAs
	 */
	public function update( $userId, $sendAsEmail, \PostSMTP\Vendor\Google\Service\Gmail\SendAs $postBody, $optParams = array() ) {
		$params = array(
			'userId'      => $userId,
			'sendAsEmail' => $sendAsEmail,
			'postBody'    => $postBody,
		...
		$params = \array_merge( $params, $optParams );
		return $this->call( 'update', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\SendAs::class );
	}
	/**
