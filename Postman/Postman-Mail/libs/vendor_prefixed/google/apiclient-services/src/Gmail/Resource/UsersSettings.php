...
class UsersSettings extends \PostSMTP\Vendor\Google\Service\Resource {
	...
	public function getAutoForwarding( $userId, $optParams = array() ) {
		...
		return $this->call( 'getAutoForwarding', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\AutoForwarding::class );
	}
	/**
	...
	public function getImap( $userId, $optParams = array() ) {
		$params = array( 'userId' => $userId );
		$params = \array_merge( $params, $optParams );
		return $this->call( 'getImap', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\ImapSettings::class );
	}
	/**
	...
	public function getLanguage( $userId, $optParams = array() ) {
		$params = array( 'userId' => $userId );
		$params = \array_merge( $params, $optParams );
		return $this->call( 'getLanguage', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\LanguageSettings::class );
	}
	/**
	...
	public function getPop( $userId, $optParams = array() ) {
		$params = array( 'userId' => $userId );
		$params = \array_merge( $params, $optParams );
		return $this->call( 'getPop', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\PopSettings::class );
	}
	/**
	...
	public function getVacation( $userId, $optParams = array() ) {
		$params = array( 'userId' => $userId );
		$params = \array_merge( $params, $optParams );
		return $this->call( 'getVacation', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\VacationSettings::class );
	}
	/**
	 ...
	 * @return AutoForwarding
	 */
	public function updateAutoForwarding( $userId, \PostSMTP\Vendor\Google\Service\Gmail\AutoForwarding $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'updateAutoForwarding', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\AutoForwarding::class );
	}
	/**
	 ...
	 * @return ImapSettings
	 */
	public function updateImap( $userId, \PostSMTP\Vendor\Google\Service\Gmail\ImapSettings $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'updateImap', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\ImapSettings::class );
	}
	/**
	 ...
	 * @return LanguageSettings
	 */
	public function updateLanguage( $userId, \PostSMTP\Vendor\Google\Service\Gmail\LanguageSettings $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'updateLanguage', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\LanguageSettings::class );
	}
	/**
	 ...
	 * @return PopSettings
	 */
	public function updatePop( $userId, \PostSMTP\Vendor\Google\Service\Gmail\PopSettings $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'updatePop', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\PopSettings::class );
	}
	/**
	 ...
	 * @return VacationSettings
	 */
	public function updateVacation( $userId, \PostSMTP\Vendor\Google\Service\Gmail\VacationSettings $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = \array_merge( $params, $optParams );
		return $this->call( 'updateVacation', array( $params ), \PostSMTP\Vendor\Google\Service\Gmail\VacationSettings::class );
	}
}
