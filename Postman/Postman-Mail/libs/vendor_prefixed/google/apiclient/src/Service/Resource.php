...
class Resource {
	...
	public function call( $name, $arguments, $expectedClass = null ) {
		...
		$request = new \PostSMTP\Vendor\GuzzleHttp\Psr7\Request( $method['httpMethod'], $url, $postBody ? array( 'content-type' => 'application/json' ) : array(), $postBody ? \json_encode( $postBody ) : '' );
		// support uploads
