...
class PostmanSuggestProSocket {
    ...
    public function promote_bundles_html() {
        ...
        ?>
        <div style="color:#000;background: #fed90f;display: inline-block;padding: 23px;border-radius: 14px;font-size: 16px;font-weight: 400;box-shadow: 5px 5px 8px #c7c7c7; padding-bottom:10px; display: flex; width: 100%;" >
            <div style="width: 75%;">
                <div>
                    <a style="text-decoration:none; color:#231F20;" href="<?php echo esc_url( 'https://postmansmtp.com/pricing/?utm_source=plugin&utm_medium=banner' ); ?>"><?php esc_html_e( '🎉 UNLOCK THE FULL POTENTIAL OF POST SMTP WITH PRO FEATURES', 'post-smtp' ); ?></a>
                </div>                
                <div style="margin-top:8px">
                    <a style="font-size:10px; color:#0019ff;" href="<?php echo admin_url( 'admin.php?action=ps_skip_pro_banner' ); ?>"><?php esc_html_e( 'Not interested, Hide for now.', 'post-smtp' ); ?></a>
                </div>
            </div>
            <div style="margin: 11px 0;">
                <a style="text-decoration:none; color:#231F20; font-size: 12px; display: block;" href="<?php echo esc_url( 'https://postmansmtp.com/pricing/?utm_source=plugin&utm_medium=banner' ); ?>"><span style="background: #000;color: #fff;text-decoration: none;padding: 10px;border-radius: 10px;"><?php esc_html_e( '👉 LEARN MORE', 'post-smtp' ); ?></span></a>
            </div>
        </div>
        <?php
