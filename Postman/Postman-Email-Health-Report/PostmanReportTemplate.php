	...
	class PostmanReportTemplate {
        ...
        <table>
           ...
           <!---->';
            ...
            if(empty($log)) {
                  $logs_html = '';
                  $logs_html .= '<tr><td colspan="5">No emails were sent '. esc_html( strtolower( $duration ) ) .'</td></tr>';
            }
       ...
       $body .='
        ...
        <tr>
            ...
            '.($is_addonactivated ? 
            ' This email was auto-generated and sent from  <a style="color: #606C7C;" href="'.get_bloginfo().'"><strong>'.get_bloginfo().'</strong></a>' 
                : 
